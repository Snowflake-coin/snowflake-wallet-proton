...
export default class Send extends Component<Props, State> {
        ...
        const modalMessage = (
          <div>
            ...
            <p className={`subtitle ${textColor}`}>
              ...
              <br />
              {atomicToHuman(amount + nodeFee + fee, true)} SNW
            </p>
            <p className={`subtitle ${textColor}`}>
              <b>Fee:</b>
              <br />
              {atomicToHuman(nodeFee + fee, true)} SNW
              {nodeFee > 0 &&
  ...
  prepareTransaction = (event: any) => {
    ...
    const sufficientUnlockedFunds = sendAll
      ? true
      : session.getUnlockedBalance() > Number(enteredAmount) / 100000000;
    ...
    const addressInput = (
      ...
      >
        <Creatable
          ...
          placeholder="Enter a Snowflake address or a contact name to send funds to"
          ...
          <div className={`maincontent ${backgroundColor} ${pageAnimationIn}`}>
            <form onSubmit={this.prepareTransaction}>
              ...
              <div className="buttons">
                {!transactionInProgress && (
                  <button type="submit" className="button is-success theme-btn is-large">
                ...
                {transactionInProgress && (
                  <button
                    type="submit"
                    className="button is-success theme-btn is-large is-loading is-disabled"
                    disabled
                  >
                    <span className="icon is-small">
                      <i className="fa fa-paper-plane" />
                ...
                {isDev && (
                  <div>
                    <a
                      className="button is-warning theme-btn is-large theme-btn-c"
                      ...
                      onMouseDown={event => event.preventDefault()}
                    >
                      <span className="icon is-small theme-btn">
