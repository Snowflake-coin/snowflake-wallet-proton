...
export default class NodeChanger extends Component<Props, State> {
  ...
  findNode = () => {
    remote.shell.openExternal('http://explorer.snowflake-net.com/nodes.html');
  };
        ...
        <div className="field has-addons is-expanded">
          ...
          {nodeChangeInProgress === true && (
            <div className="control">
              <button className="button is-success theme-btn is-loading">
          ...
          {nodeChangeInProgress === false && (
            <div className="control">
              <button className="button is-success theme-btn" onClick={this.changeNode}>
                <span className="icon is-small">
                  <i className="fa fa-network-wired" />
                </span>
                &nbsp;&nbsp;{il8n.connect}
