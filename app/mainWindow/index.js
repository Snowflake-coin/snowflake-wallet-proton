...
export const directories = [
  `${homedir}/.snowflakewallet`,
  `${homedir}/.snowflakewallet/logs`
];
...
log.debug(`Snowflake wallet started...`);
...
function handleHelp() {
  remote.shell.openExternal('https://discord.gg/VeuwgBRvXM');
}

function handleIssues() {
  remote.shell.openExternal(
    'https://github.com/Snowflake-coin/snowflake-wallet-proton/issues'
  );
}
